...
import { AlertTriangle, WifiOff, ArrowRight, BatteryWarning, MapPin, Search, RefreshCw, X, RotateCcw, Map as MapIcon, Activity, Zap, Shield, ChevronRight, BarChart3, Radio } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full text-slate-200 gap-5 pb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
         <StatCard label="최근 화재 발생" value={stats[0].value} color="bg-red-500" icon={AlertTriangle} />
         <StatCard label="최근 고장 발생" value={stats[1].value} color="bg-orange-500" icon={BatteryWarning} />
         <StatCard label="통신 이상" value={stats[2].value} color="bg-gray-400" icon={WifiOff} />
